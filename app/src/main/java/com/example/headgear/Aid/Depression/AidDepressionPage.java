...
import com.example.headgear.Adapter.AidDepressionAdapter;
...
public class AidDepressionPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aid_depression_page);
        fab = findViewById(R.id.refreshdepression);
    ...
    private void initRecyclerView() {
        AidDepressionAdapter aidDepressionAdapter = new AidDepressionAdapter(aidDepressionSubList);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(aidDepressionAdapter);
    }

    private void initData() {
        aidDepressionSubList = new ArrayList<>();

        DatabaseReference databaseReference =
                FirebaseDatabase.getInstance().getReference("AidDepression");
        ...
        GET_AID_DEFINITION.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                aidDepressionSubList.add(new AidDepressionSub(aid.getTitle(), aid.getImage(), aid.getDescription()));
            }
